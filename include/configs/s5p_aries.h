...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"onenand_boot=" \
		...
		"onenand read ${kernel_addr_r} ${onenand_load_offset} 0xA00000;" \
	...
	"bootmenu_4=Distro Boot mmc 0 Boot=setenv default_boot_mode mmc0; saveenv;run bootcmd_mmc0;\0" \
	"bootmenu_5=SD Card - Mass Storage=ums 0 mmc 0;\0" \
	"bootmenu_6=Distro Boot mmc 1 Boot=setenv default_boot_mode mmc1; saveenv;run bootcmd_mmc1;\0" \
	"bootmenu_7=MMC - Mass Storage=ums 0 mmc 1;\0"

#define MMC_BOOTMENU1	"bootmenu_6"
#define MMC_BOOTMENU2	"bootmenu_7"
